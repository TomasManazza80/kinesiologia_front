    ...
    return (
        <Table>
            <TableHeader>
                ...
                <TableRow>
                    <TableHead className="font-700 text-center">Unidad</TableHead>
                    <TableHead>Número de unidad</TableHead>
                    <TableHead>Piso</TableHead>
                    <TableHead>Tamaño de unidad</TableHead>
                    <TableHead>Número de pisos</TableHead>
                    <TableHead>Número de habitaciones</TableHead>
                    <TableHead>Número de dormitorios</TableHead>
                    <TableHead>Número de baños</TableHead>
                    <TableHead>Garajes</TableHead>
                    <TableHead>Estado</TableHead>
                    <TableHead>Precio de alquiler</TableHead>
                    <TableHead></TableHead>
                </TableRow>
            </TableHeader>
            <TableBody>
