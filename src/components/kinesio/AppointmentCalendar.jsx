...
import { Filter, CalendarDays, Download, Search, HeadphonesIcon, LayoutGrid, ChevronLeft, ChevronRight, X } from "lucide-react";
import { 
...
const AppointmentCalendar = () => {
  ...
  const activeProfessionalId = selectedProfessional || (professionals.length > 0 ? professionals[0].id : user?.id);
                        ...
                        return (
                            <div 
                                ...
                                className={`p-1.5 rounded-full cursor-pointer transition-colors ${
                                    isSelected ? 'bg-[#3B82F6] text-white shadow-sm' 
